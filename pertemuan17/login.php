...
if(isset($_COOKIE["id"]) && $_COOKIE["key"]){
    ...
    $result = mysqli_query($koneksi, "select username from user where id_akun = $id");
    ...
    if(mysqli_num_rows($result) === 1) {
        ...
        if(password_verify($password, $row["password"])){
            ...
            if(isset($_POST['remember'])) {
                ...
                setcookie('id', $row['id_akun'], time() + 3600);
...
<body>
    ...
    <ul>
        ...
        <li>
            <input type="checkbox" id="remember" name="remember" class="from-control">
